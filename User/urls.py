...
from User.forms import PwdResetForm, UserLoginForm, PwdResetConfirmForm
from User.views import  CategoryListView, BookCreateView

app_name = 'account'

urlpatterns = [
    path('login/', auth_views.LoginView.as_view(template_name='login.html', form_class=UserLoginForm), name='login'),
    ...
    path('staff/', views.staff, name='staffs'),
    path('new_Book/', BookCreateView.as_view(), name='book_new'),
    path('categories/', CategoryListView.as_view(), name='categories'),
    path('new_category/', views.category_create, name='category_new'),
